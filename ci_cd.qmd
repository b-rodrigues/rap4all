...
[repository](https://github.com/b-rodrigues/ga_demo/tree/main). This repository
contains a Dockerfile, and a `.github/workflows/` folder with a Github Actions
workflow file. Each time I push any change to any file from this repository, a
new Docker image gets built automatically and pushed to Docker Hub. I will
now teach you how to do this.

As stated before, the advantage of using Docker images for your RAPs instead of
simply running them directly inside Github Actions, is that you don't rely on
Github to have the base image (in our example, `ubuntu-22.04`), forever
available, which they won't.
