...
jobs:
  ...
  build:
    ...
    - name: Docker Run Action
      run: docker run --rm --name housing_container -v /github/workspace/shared_folder:/home/housing/shared_folder:rw housing_image
...
`/home/` directory on a Linux machine.
