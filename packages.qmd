...
sure that the analysis is of high quality. So if you start messing with your
...
You can select the code inside the `description` chunk and then run it in the
console. This will create the package’s `DESCRIPTION` file.
...
file, add some usual dependencies, as so one. But let’s ignore this for now, and
