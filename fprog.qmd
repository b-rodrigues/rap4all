...
So if `mtcars` is a data frame, it encapsulates a `print()` method that then does the printing.
...
All of this to say that if you want to extend R by writing packges, learning some OOP essentials
is also important. But for data analysis, functional programming does the job perfectly.
To learn more about R’s different OOP systems (yes, R can do OOP in diffirent ways), 
take a look at @wickham2019. 
...
other paradigms, like object oriented programming, are also available to you. It is important
however to distinguish when you need to use one or the other.
