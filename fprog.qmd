...
download.file(
  "https://github.com/b-rodrigues/ myPackage/raw/main/data/unemp.rda",
  destfile = unemp_path)
...
with](https://withr.r-lib.org/reference/index.html)^[https://withr.r-lib.org/reference/index.html].
