...
project. As a reminder, here are the files:

- save_data.R: [https://is.gd/7PhUjd](https://is.gd/7PhUjd)
- analysis.R: [https://is.gd/X7XXJg](https://is.gd/X7XXJg)

from our project. The `analysis.R` file already includes one change: the one
...
This is much more detailed than using comments. Then comes a function to
download and get the data. This function simply wraps the lines from our
original script that did the downloading and the cleaning. As a reminder, here
are the lines from the original script:
