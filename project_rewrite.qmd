...
option `eval = F`, like I did, you could use `include = F`, so it doesn’t appear in
the compiled document at all. The first time you compile this document, you could
...
This is up to you, and it also depends on who the audience of the knitted output is (do they
