...
<figure>
    ...
    <figcaption>Wanting to run older version of analytics software is a recurrent need.</figcaption>
</figure>
...
release, the less errors get raised (if you want to run the code for yourself,
...
![The reproducibility spectrum from Peng’s 2011 paper.](images/repro_spectrum.png)
