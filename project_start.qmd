...
to see the finalised script. Also read some of the comments the I’ve added. This
...
All of this still needs to get documented, but listing the packages that were
...
though this is has not happened in a long time, it is not entirely out of the
question).
...
the last part of the `analysis.R` script: we copy and pasted the same code 5
