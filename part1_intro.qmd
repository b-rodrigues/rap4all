...
The first idea we are going to focus on is Don’t Repeat Yourself.
Simply by avoiding having to repeat oneself, we will naturally
implement best practices to make our pipelines reproducible.
...
data together. We are going to download, clean and plot some data, and we will
