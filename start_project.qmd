...
For something publication-worthy, we recommend the `{flextable}` package:
...
[whole, free, ebook on it](https://ardata-fr.github.io/flextable-book/index.html).

The next package is `{modelsummary}`, and this one focuses on regression tables. It is extremely
powerful as well, and just like `{flextable}`, works for any type of output.
