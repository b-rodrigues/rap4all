...
tools that I've showed you, this should not be the case, and you might end up
even gaining time. The only exception to this will be preparing a Docker image,
but if you supply at the very least an `renv.lock` file, creating a Docker image
to run a project could even be done much later, and only if it's really needed
(and maybe even by someone else).

# "So what?"

If you’ve reached this conclusion and are still thinking "meh, yeah,
reproducibility is nice and all, but... so what?" I hope to this last attempt of
mine to convince you that RAPs are important will be successful.
