...
The last sentence from this example has an inline code chunk. This is quite useful,
...
into the example from before and render either a PDF or a html document
...
go much farther than that. For example, suppose that we need to write a document
...
The last function, named `return_section()` uses `knitr::knit_expand()`, which
...
Let's modify the example from before, which consisted of creating one section
...
It is important not to fall to the temptation of copy and pasting sections of
